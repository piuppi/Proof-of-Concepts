...
- **2022-07-24**: Got mail from Syracom saying, _"Hello Gianluca, Thanks for the security info. We have access to Atlassian's data. We'll now check the functionality. Appreciate the details. Regards"._
- **2022-07-25**: Got mail from Atlassian Security Team saying, _"Hello Gianluca, Thanks for notifying Atlassian. We've provided the plugin developer with details and are in touch with the vendor via a ticket ("AMS-*****"). As this isn't an Atlassian component, we're closing this issue."._
...
- **2022-08-23**: Got mail saying, _"Hello Gianluca, We analyzed the issue and are working on a fix. Thanks for asking. Best regards"._
...
- **2022-09-21**: Got mail saying, _"Thanks for asking, Gianluca. We found a solution and are now testing the Fix, which takes time as we want to ensure everything works as designed. Regards"._
...
- **2022-11-11**: Got mail saying, _"Hello Gianluca, We fixed the bug with version 3.1.1.0 on 26th October and the security ticket is now "patched". Thank you for the description - it was very helpful in identifying the bug. Sorry for the delay. Best regards"._
...
- **2022-11-16**: Got mail saying, _"I haven't forgotten your request; we're just a bit busy. I'll get back to you soon. Best regards"._
